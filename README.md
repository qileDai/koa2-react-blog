...
本项目已不再维护，项目已经升级到 ssr 版本，沿用并改进了 UI。新项目地址 [remix-ssr-blog](https://github.com/qileDai/remix-ssr-blog)。欢迎继续关注！
...
* 我的博客地址: [梧桐树的博客](https://blog.alvin.run)

声明：博客仅做展示使用，（之前被比特币攻击了），所需数据已重置。

<!-- * 测试博客地址: [测试使用的梧桐树的博客](https://test.alvin.run)) `admin/admin` 为博主账号 小伙伴可以使用看看博客的完整功能！ -->
...
// project config
export const HEADER_BLOG_NAME = '梧桐树的博客' // header title 显示的名字
...
export const SIDEBAR = {
  ...
  // 个人主页
  homepages: {
    github: 'https://github.com/qileDai',
